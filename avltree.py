...
Original file is located at
    https://colab.research.google.com/drive/1e0s6dgwCPWTeZGqgYJH3WeAD-XEtUb2G
"""
...
class AVLTree:
	...
	def _insert(self,value,cur_node):
		if value<cur_node.value:
			...
			print("Registro já está na árvore!")
	...
	def mostra(self,value):
		if self.root!=None:
			return self._mostra(value,self.root)
		#else:
			#return None

	def _mostra(self,value,cur_node):
		if value==cur_node.value:
			print ('h=%d' %cur_node.height)
			
		elif value<cur_node.value and cur_node.left_child!=None:
			return self._mostra(value,cur_node.left_child)
		elif value>cur_node.value and cur_node.right_child!=None:
			return self._mostra(value,cur_node.right_child)
...
n = int(input())
insersao = "| Registro a ser inserido: |\n "
procura = "| Registro a ser procurado: |\n "
delesao = "| Registro a ser deletado: |\n "
for i in range(n):
	print (insersao)
	b = int(input())
	while a.search(b) == True:
		i -= 1
		print("Registro existente na AVL\n")
		print (insersao)
		b = int(input())
	while a.search(b) == False:
		a.insert(b)
		z.insert(b)
		print(a)
...
while l < n:
	...
	if a.search(c) == True:
		...
		print("Não há esse registro na AVL")

g = 0
k = int(input("| Quantas deleções: |\n"))
